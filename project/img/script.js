...
const OPENAI_API_KEY = "sk-proj-6rWAjYUVUbizKDNVXRYeT3BlbkFJPdHYxEKtyYQxMpVvV2tO";
  ...
  try {
    ...
    const response = await fetch("https://api.openai.com/v1/images/generations", {
      ...
      headers: {
        ...
        "Authorization": `Bearer sk-proj-6rWAjYUVUbizKDNVXRYeT3BlbkFJPdHYxEKtyYQxMpVvV2tO`,
      },
      body: JSON.stringify({
        prompt: userPrompt,
        n: userImgQuantity,
...
const handleImageGeneration = (e) => {
  ...
  const imgCardMarkup = Array.from({ length: userImgQuantity }, () => 
      `<div class="img-card loading">
        <img src="images/loader.jpeg" alt="Loading...">
